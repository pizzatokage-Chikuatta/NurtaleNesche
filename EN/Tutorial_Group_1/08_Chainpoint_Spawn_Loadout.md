Chainpoint Spawn Loadout
================================
This tutorial changes the list of chainpoint spawn IDs used when a stage starts.

Step 1
--------
Create the following folder hierarchy under the "Mods" folder.
Mods\Mod_{YourName}\Chainpoints\Mod Initial Spawn Loadouts\Initial Spawn Loadouts
...
```
1. For this tutorial, "type" must be "chainPointSpawnLoadouts".
...
Step 4
--------
Copy "chainpoint_spawn_loadout.stage_03.json" from:
...
Step 5
--------
Edit "chainpoint_spawn_loadout.stage_03.json".
1. "id": do not change it when overriding the stage loadout.
2. "spawnIds": chainpoint spawn IDs used by this stage.

Finally, open the game main menu -> Mods -> Mod Report and check whether the mod was imported correctly.

Notes
--------
1. Adding a new chainpoint spawn JSON is not enough. The loadout must include its ID.
2. If a spawn ID is missing or misspelled, the chainpoint will not spawn.
