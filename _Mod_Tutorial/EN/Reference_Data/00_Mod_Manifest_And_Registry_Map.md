...
Use this when the mod targets one actor, such as a Goblin controller or animation set.
...
2. "target" is the actor/controller target id.
3. "variant" is usually "" or "Base" unless the tutorial says otherwise.
